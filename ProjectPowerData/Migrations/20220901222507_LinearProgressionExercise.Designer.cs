...
namespace ProjectPowerData.Migrations
{
    ...
    [Migration("20220901222507_LinearProgressionExercise")]
    partial class LinearProgressionExercise
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectPowerData.Folder.Models.Exercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasDiscriminator<string>("Template").HasValue("Exercise");
                });
            ...
            modelBuilder.Entity("ProjectPowerData.Folder.Models.User", b =>
                {
            ...
            modelBuilder.Entity("ProjectPowerData.Folder.Models.A2SHyperTrophy", b =>
                {
                    b.HasBaseType("ProjectPowerData.Folder.Models.Exercise");
            ...
            modelBuilder.Entity("ProjectPowerData.Folder.Models.UserRole", b =>
                {
                    ...
                    b.HasOne("ProjectPowerData.Folder.Models.User", "UserAccount")
                        .WithMany("UserRoles")
