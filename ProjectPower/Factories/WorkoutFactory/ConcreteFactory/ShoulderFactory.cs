...
{
    class ShoulderFactory : WorkoutFactory
    {
        ...
        public ShoulderFactory(int currentWave, int currentWaveIndex, ExerciseList e)
        {
        ...
        {
            return new Shoulders(_currentWave, _currentWaveIndex, _exerciseList);
        }
    }
}
